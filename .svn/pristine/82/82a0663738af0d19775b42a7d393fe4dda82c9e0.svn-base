...
//	jQuery("body").append("<div class='demo-settings" +
//	    "'></div>");
//	jQuery(".demo-settings").append("<a href='#show-settings' class='demo-button'><i class='fa fa-gear'></i>Config</a>");
//	jQuery(".demo-settings").append("<div class='demo-options'>"+
//										"<div class='title'>Config</div>"+
//										"<a href='#demo' rel='font-options' class='option'><img src='/content/images/demo/image-1.png' class='demo-icon' alt='' /><span>Tipo de fuente</span><p>Cambiar fuente</p></a>"+
//										"<div class='option-box' rel='font-options'>"+
//											"<div alt='font-options'>"+
//												"<b class='sub-title'>Titulos & Menu Fuente</b>"+
...
//											"</div>"+
//										"</div>"+
//										"<a href='#demo' rel='color-options' class='option'><img src='/content/images/demo/image-2.png' class='demo-icon' alt='' /><span>Colores</span><p>Color de panel</p></a>"+
//										"<div class='option-box' rel='color-options'>"+
//											"<div alt='color-options'>"+
//												"<b class='sub-title'>Color de encabezado</b>"+
...
//												"<b class='sub-title'>Color de pie de pagina</b>"+
...
//											"</div>"+
//										"</div>"+
//										"<a href='#demo' rel='background' class='option'><img src='/content/images/demo/image-3.png' class='demo-icon' alt='' /><span>Color de fondo</span><p>Textura de fondo</p></a>"+
//										"<div class='option-box' rel='background'>"+
//											"<div alt='background'>"+
//												"<b class='sub-title'>Textura de fondo</b>"+
...
//											"</div>"+
//										"</div>"+
//										"<a href='#demo' rel='page-width' class='option'><img src='/content/images/demo/image-4.png' class='demo-icon' alt='' /><span>Cambiar tamano</span><p>Caja o Pantalla completa</p></a>"+
//										"<div class='option-box' rel='page-width'>"+
//											"<div alt='option-box'>"+
//												"<b class='sub-title'>Cambiar tamano de pantalla</b>"+
//												"<a href='#' class='option-bulb' rel='full'>Pantalla completa</a>"+
//												"<a href='#' class='option-bulb active' rel='boxed'>Caja</a>"+
//											"</div>"+
//										"</div>"+
//									"</div>");
